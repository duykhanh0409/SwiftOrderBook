...
func createCountryPopulationDictUsingActor() async -> [String: Int] {
...
func createCountryPopulationDict() async -> [String: Int] {
    ...
    await withTaskGroup(of: (String, Int).self) { group in
        ...
        for await (country, population) in group {
...
Task {
    let dictionary = await createCountryPopulationDictUsingActor()
    print(dictionary)
}
